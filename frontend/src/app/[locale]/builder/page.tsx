...
import {
  ArrowLeft, Bot, CheckCircle2, Code2, Copy, Cpu, Download, Eye, Globe, Layers, Loader2,
...
// Refactor (Feature 4): builder/page.tsx monolitidan ajratilgan
// presentational helperlar — uz/ru/en lokalizatsiya, generation UI,
// phase badge, build trigger detect. AI flow va API logikasi bu
// yerda qoldi (xavfsizroq).
import {
  GenerationProgress,
...
// GenerationStats interface — _buildHelpers.tsx ichidan import qilinadi.
